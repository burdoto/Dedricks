...
public class O extends Piece {
    ...
    static {
        ...
        point[1][1] = new Point(0, 1); // bottom
        point[1][2] = new Point(1, 0); // left
        point[1][3] = new Point(1, 1); // right

        point[2] = new Point[4];
        point[2][0] = new Point(0, 0); // origin / center
        point[2][1] = new Point(0, 1); // bottom
        point[2][2] = new Point(1, 0); // left
        point[2][3] = new Point(1, 1); // right

        point[3] = new Point[4];
        point[3][0] = new Point(0, 0); // origin / center
        point[3][1] = new Point(0, 1); // bottom
        point[3][2] = new Point(1, 0); // left
        point[3][3] = new Point(1, 1); // right
    }

    protected O(Board board, Game game, int startX, Color color) {
        super('O', game, board, startX, color, new int[]{0,0,0,0});
    }
}
